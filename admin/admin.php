...
$c=$conn->query("select * from instreg" );
...
<td>
<form action="approveinst.php" method="post">
<input type="hidden" name="iid" value="<?php echo $r['iid'];?>" />
<input type="submit" name="approve" value="approve" /></form></td>

<td> <form action="disapproveinst.php" method="post">
<input type="hidden" name="iid" value="<?php echo $r['iid'];?>" />
